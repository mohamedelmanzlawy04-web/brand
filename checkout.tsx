...
:root {
  ...
  --sidebar-primary: 206 85% 25%;
  --sidebar-primary-foreground: 0 0% 98%;
  --sidebar-accent: 195 80% 40%;
  --sidebar-accent-foreground: 0 0% 100%;
  --sidebar-ring: 206 85% 25%;
  --popover: 0 0% 100%;
  ...
  --shadow-2xs: 0px 2px 0px 0px hsl(220 15% 10% / 0.05);
  --shadow-xs: 0px 2px 0px 0px hsl(220 15% 10% / 0.05);
  --shadow-sm: 0 1px 2px 0 hsl(220 15% 10% / 0.05);
  --shadow: 0 1px 2px 0 hsl(220 15% 10% / 0.05);
  --shadow-md: 0 4px 6px -1px hsl(220 15% 10% / 0.08), 0 2px 4px -2px hsl(220 15% 10% / 0.06);
  --shadow-lg: 0 10px 15px -3px hsl(220 15% 10% / 0.10), 0 4px 6px -4px hsl(220 15% 10% / 0.07);
  --shadow-xl: 0 20px 25px -5px hsl(220 15% 10% / 0.1), 0 8px 10px -6px hsl(220 15% 10% / 0.1);
  --shadow-2xl: 0 25px 50px -12px hsl(220 15% 10% / 0.25);
  --tracking-normal: 0em;
  --spacing: 0.25rem;
...
.dark {
  ...
  --sidebar-accent: 195 80% 60%;
  --sidebar-accent-foreground: 222 30% 7%;
  ...
  --shadow: 0 1px 2px 0 hsl(0 0% 0% / 0.5);
